...
> **Note:** The [portfolio-rag-chat](https://github.com/paulxiep/code-rag), [quant-trading-gym](https://github.com/paulxiep/quant-trading-gym) and [invoice-parse](https://github.com/paulxiep/invoice-parse) have been migrated to their own repository fully. Also available on [project list on new personal website](https://paulxie.com/projects).
