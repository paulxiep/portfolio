...
2. [portfolio-rag-chat](portfolio-rag-chat) (Rust + Dockerfile): RAG chatbot that answers questions about code repositories. Parses Rust, Python, and TypeScript with tree-sitter, extracts docstrings, incremental ingestion via SHA256 hashing. Being expanded with code-raptor toward hierarchical code embeddings and emergent architectural understanding (RAPTOR-style).
