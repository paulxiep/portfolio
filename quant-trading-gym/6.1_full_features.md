...
V6.1 introduces a **declarative feature registry** that replaces scattered parallel arrays with a single source of truth per feature. This is the architectural foundation for V6.2 (SHAP metadata), V6.3 (gym observation space), V6.4 (PyO3 schema export), and V7.2 (NN normalization ranges).
